This is a simple counter application built with JavaScript, HTML and CSS. The app allows the user to increment or decrement a number by pressing the "+" or "-" button respectively.
